...
const testimonials = [
  ...
  {
    quote:
      'The ability to query our database in plain English has democratized data access across our entire organization.',
    author: 'Jessica Smith',
    position: 'CEO, DataFirst',
  },
  {
    quote:
      'Our non-technical staff can now get the data insights they need without waiting for the data team.',
